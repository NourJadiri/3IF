...
enum returnCodes { OK = 200, PARTIAL_CONTENT = 206, PREMANENT_REDIRECT = 301, TEMPORARY_REDIRECT = 302,
                NOT_MODIFIED = 304, UNAUTHORIZED = 401, FORBIDDEN = 403, PAGE_NOT_FOUND = 404, METHOD_NOT_ALLOWED = 405,
