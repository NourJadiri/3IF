...
| $E(W)$ | $\lambda$ | $E(N)$ | $\lambda * E(W)$ | ecart |
|--------|-----------|--------|------------------|-------|
| 0.077  | 10        | 1.1    | 0.77             | 30%   |
| 0.15   | 14        | 2.4    | 2.1              | 12%   |
| 0.43   | 20        | 8.6    | 8.6              | 0%    |
| 1.4    | 30        | 45     | 41               | 9%    |

On remarque qu'a l'exception de la moyenne du troisième test, on se rapproche de plus en plus de la formule de Little, plus le taux d'arrivée augmente.
